...
-- ============================================================
-- ✅ Done. Summary:
--   • Tables: profiles (+badges/counters), favorites, comments, anime_seasons,
--     user_library, anime_recommendations, anime_schedule, anime_reactions,
--     anime_reviews, mal_sync_jobs, translation_cache, comment_votes
...
--   • Helpers: grant_badge(uuid, text), revoke_badge(uuid, text)
-- ============================================================
